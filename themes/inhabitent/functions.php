...
function inhabitent_scripts() {
	...
	wp_enqueue_script('theme-script', 	get_template_directory_uri() . '/build/js/theme-scripts.min.js', array('jquery'), false, true );

	// wp_localize_script('tent_comments', 'comment_vars', array(
	// 		'rest_url' => rest_url(),
